...
from src.rag import run_rag, run_rag_async
...
def test_rag_pipeline_runs_async(tmp_path: Path) -> None:
    """Pipeline 3 can run through Haystack AsyncPipeline.run_async."""
